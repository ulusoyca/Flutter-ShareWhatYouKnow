...
import 'package:ulusoyapps_flutter/003-single-page-scrollable-web/003-02-scroll-to-page/shape_border_listview_02.dart';
...
class _ColorSectionsState extends State<ColorSections> {
  ...
  void _onUserScroll() {
    final pageIndex = _pageController.page.floor();
